...
var (
	host   = flag.String("H", "127.0.0.1", "the mysql host")
	port   = flag.Int("P", 3306, "the mysql port")
	user   = flag.String("u", "root", "the mysql user")
	passwd = flag.String("p", "123456", "the mysql password")
	dbName = flag.String("n", "test", "the mysql database name")
